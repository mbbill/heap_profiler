...
// mbbill:
// generate gperftools-compatible output like below:
/*
heap profile:      5:      320 [     5:      320] @ heapprofile
1:      100 [     1:      100] @ 0x0040058f 0x004005ad 0x004005d1 0x7fb437f11ec5 0x004004b9 0x00000000
1:      100 [     1:      100] @ 0x0040058f 0x004005ad 0x004005bd 0x7fb437f11ec5 0x004004b9 0x00000000
1:      100 [     1:      100] @ 0x0040058f 0x004005c7 0x7fb437f11ec5 0x004004b9 0x00000000
1:       10 [     1:       10] @ 0x004005a3 0x004005bd 0x7fb437f11ec5 0x004004b9 0x00000000
1:       10 [     1:       10] @ 0x004005a3 0x004005d1 0x7fb437f11ec5 0x004004b9 0x00000000

MAPPED_LIBRARIES:
00400000-00401000 r-xp 00000000 00:00 7080676     /home/billming/mtt/heap_profiler/a.out
00600000-00601000 r--p 00000000 00:00 7080676     /home/billming/mtt/heap_profiler/a.out
00601000-00602000 rw-p 00001000 00:00 7080676     /home/billming/mtt/heap_profiler/a.out
019b2000-022b2000 rw-p 00000000 00:00 0           [heap]
7fb436d11000-7fb436e71000 rw-p 00000000 00:00 0           
7fb436e71000-7fb436e74000 r-xp 00000000 00:00 4854782     /lib/x86_64-linux-gnu/libdl-2.19.so
*/
...
int main(int argc, char** argv) {
  ...
  fp = stdout;
  while (((c = getopt(argc, argv, "xno:")) & 0x80) == 0) {
   switch (c) {
      case 'o':
        printf("Writing to %s\n",optarg);
        fp = fopen(optarg, "w");
  ...
  if (optind >= argc) {
    printf("Usage: %s [-o file] [-n] [-x] [-c comment] pid\n"
           "  -o: Output to file.\n"
